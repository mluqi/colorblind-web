          ...
          <div className="flex flex-col xl:flex-row items-center justify-between gap-8 xl:gap-16">
            ...
            <div className="text-left w-full xl:w-1/2 space-y-6 md:space-y-8 z-10 pt-8 md:pt-12">
              <div className="flex flex-col space-y-2">
                <span className="text-red-500 font-medium tracking-wider text-xs uppercase lg:text-base">
                ...
                <GlitchText
                  ...
                  enableShadows={true}
                  enableOnHover={false}
                  className="text-4xl sm:text-xl md:text-6xl lg:text-7xl font-bold leading-tight"
                >
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                ...
                <Link href="#about">
                  <Button
                    variant="outline"
                    className="text-lg px-8 py-6 rounded-full border-white/30 hover:border-white/50 hover:bg-white/5 transition-all transform hover:scale-105 font-semibold"
                  >
                    Learn More
                  </Button>
                </Link>
